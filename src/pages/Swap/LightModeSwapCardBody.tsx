...
import LightModeCurrencyINputPanel from 'components/CurrencyInputPanel/LightModeCurrencyINputPanel'
...
const LightModeSwapCardBody = () => {
  ...
  return (<CardBody className="white-mode-swap-card-container-style">
    <AutoColumn gap="md">
        ...
        <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '0 1rem' }}>
          <ArrowWrapper clickable>
            <IconButton
              ...
              size="sm"
            >
              <ArrowDownIcon color="black" width="24px" />
            </IconButton>
          </ArrowWrapper>
...
export default LightModeSwapCardBody
