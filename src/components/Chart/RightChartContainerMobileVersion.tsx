...
const RightChartContainer = (props) => {
  ...
  function formattedPrice(price) {
    let formattedNumber = Number(price).toPrecision(8);
  ...
  return (<div>
  {isDark ? <div className="chart-page-new-design-right-colum-top-conatiner-style-here2">
              ...
              <AutoColumn justify="space-between">
                <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '0 1rem' }}>
                  <ArrowWrapper clickable>
                    <IconButton
                      variant="tertiary"
                      style={{ borderRadius: '50%', backgroundColor: "#b4b4b4" }}
                      size="sm"
                    >
                      <div className="center">
                        <ArrowDownIcon color="primary" width="24px" />
